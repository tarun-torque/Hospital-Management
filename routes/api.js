...
import { addDoctorService, allArticle, allBlog, allDoctors, allYt, bookSlot, CreateDoctor_profile, deleteDoctor_profile, deletePatientSupport, doctorLogin, eachSupport, getAllAvailableSlots, getAvailableSlotsDoctor, getDoctorProfile, getDoctorsByServiceId, getServiceFromId, getServicesByDoctorId, patientAllSupport, patientSupport, searchDoctorAndServices, signInDoctorFromGoogle, trendingConsultant, upcomingSession, updateAvailability, updateDoctorProfile, updateDoctorRemarks, updateDoctorStatus, updateSupport } from "../controllers/doctor.controller.js";
