...
// admin notifications
router.put('/marked/admin/notification/asRead/:notificationId',markAdminNotificationAsRead)
router.get('/get/admin/unread/notification', getAdminUnreadNotification)
router.get('/get/admin/read/notification', getAdminReadNotification)
...
// admin stats
router.get('/get/admin/stats',adminStats)
...
router.post('/doctor/add/service/:serviceId/:doctorId', addDoctorService)
